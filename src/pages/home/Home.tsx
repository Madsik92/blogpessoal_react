...
function Home() {
    return (
        <>
        <div className="w-screen flex justify-center bg-neutral-200">
            <div className="font-sora container grid grid-cols-1 md:grid-cols-2 text-stone-800">
                <div className="antialiased font-medium order-2 md:order-1 flex flex-col items-center justify-center gap-4 px-4 py-4">
                    ...
                    <div className="flex justify-around gap-4">
                        <div className="bg-neutral-400 rounded-2xl px-6 py-2 uppercase text-stone-50 text-base hover:bg-cyan-700">
                            Nova postagem
                        </div>
                    </div>
                </div>
