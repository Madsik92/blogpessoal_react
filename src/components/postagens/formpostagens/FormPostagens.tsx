        ...
        <div className=" font-sora container flex flex-col mx-auto items-center">
            ...
            <form className="flex flex-col w-4/5 md:w-3/5 gap-3" onSubmit={gerarNovaPostagem}>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <select name="tema" id="tema" className='border-1 border-neutral-400 p-2 rounded-2xl' onChange={(e) => buscarTemaPorId(e.currentTarget.value)} >
                ...
                <button 
                    type='submit' 
                    className='rounded-2xl disabled:bg-slate-200 bg-neutral-400 hover:bg-cyan-700 duration-500 text-white font-bold w-2/3 mx-auto py-2 flex justify-center'
